...
import { Kanban, Eye, EyeOff, Loader2, Lock, Mail, ArrowRight, Sun, Moon } from 'lucide-react';
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight">
            Welcome to <span className="text-brand-500">Kanban</span> Pro
          </h2>
          <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
            Sign in to access your boards, calendar schedules, and tasks.
          </p>
        </div>
        ...
        <div className="mt-8 bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl p-8 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 bg-brand-600 hover:bg-brand-500 text-white font-bold text-sm rounded-xl shadow-lg shadow-brand-600/30 transition-all hover:scale-[1.01] disabled:opacity-50 mt-2"
            >
              {loading ? (
                <>
